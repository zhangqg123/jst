...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/work/thingjs/artemis/cameraList", "anon");
		filterChainDefinitionMap.put("/work/thingjs/artemis/gateList", "anon");
		...
		//jd 
		filterChainDefinitionMap.put("/jd/jdZutaiInfo/**", "anon"); //jd
