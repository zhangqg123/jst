...
public class SaxDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        saxParser.parse("src/main/resources/data.xml",handel);
    }
}
...
class SAXDemoHandel extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (qName.equals("ITRoom")){
            System.out.println("============开始遍历ITRoom=============");
            //System.out.println(attributes.getValue("rollno"));
        }
//        else if (!qName.equals("ITRoom")&&!qName.equals("class")){
