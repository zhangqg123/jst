...
public class SnmpUtilSendTrap {
	...
	public void initComm() throws IOException {
		...
		// 设置管理进程的IP和端口
		targetAddress = GenericAddress.parse("udp:192.168.1.199/162");
	...
	public void sendPDU() throws IOException {
		...
		// 创建 PDU
		PDU pdu = new PDU();
		pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.34672.20.1.3.1.80.2.1.3.1"),
				new OctetString("SnmpTrap")));
		pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.34672.20.1.3.1.80.2.1.3.2"),
